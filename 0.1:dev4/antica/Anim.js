...
antica.Anim = class Anim {
    ...
    #axesProxy = new Proxy({}, {
        ...
        set: (_, property, value) => {
            ...
            if (value instanceof Object) {
                ...
                let axes = this.#eval();
                axes[`${property}`].value = +value;
                axes[`${property}`].target = +value;
                axes[`${property}`].vel = 0;
                this.#updateFunctions(axes);
            }
            return true;
    ...
    #values = new Proxy({}, {
        ...
        has: (_, property) => property in this.#axes,
        ownKeys: () => Object.keys(this.#axes),
        getOwnPropertyDescriptor: (_, property) => property in this.#axes ? {value: this.#axes[property].proxy.value, writable: false, enumerable: true, configurable: false} : undefined,
    });
    get values() {
        return this.#values;
    }
