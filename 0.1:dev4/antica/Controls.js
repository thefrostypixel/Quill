...
antica.KeyboardKey = class KeyboardKey extends antica.Key {
    ...
    constructor(code = "Unknown Keyboard Key", time, mouse) {
        ...
        if (typeof code == "string") {
            ...
            this.#tName = translated.indexOf(code) > -1 ? `key.keyboard.${antica.Translations.toKey(code)}` : !code.indexOf("Numpad ") && code.length == 8 ? `key.keyboard.numpad[number:"${code[7]}"]` : undefined;
            ...
            if (this.#modifierCode) {
                ...
                this.#tModifierName = `key.keyboard.${antica.Translations.toKey(this.modifierName)}`;
                ...
                this.#tName = this.modifierSide ? `key.keyboard.${antica.Translations.toKey(this.modifierName)}.${antica.Translations.toKey(this.modifierSide)}` : `key.keyboard.${antica.Translations.toKey(this.modifierName)}`;
            }
            ...
            if (!code.indexOf("Digit")) {
                ...
                this.#tName = `key.keyboard.${antica.Translations.toKey(this.code)}`;
                ...
                this.#tName = translated.indexOf(this.#code) > -1 ? `key.keyboard.${antica.Translations.toKey(this.code)}` : undefined;
            }
            if (this.modifierCode) {
                this.#tModifierName = `key.keyboard.${antica.Translations.toKey(this.modifierName)}`;
                this.#modifierSide = code.indexOf("Left") > -1 ? "Left" : "Right";
                this.#tModifierSide = `key.keyboard.modifier-side.${antica.Translations.toKey(this.modifierSide)}`;
                this.#code = `${this.modifierSide} ${this.modifierCode}`;
                this.#name = `${this.modifierSide} ${this.modifierName}`;
                this.#tName = `key.keyboard.${antica.Translations.toKey(this.modifierName)}.${antica.Translations.toKey(this.modifierSide)}`;
            }
        }
    }
};
